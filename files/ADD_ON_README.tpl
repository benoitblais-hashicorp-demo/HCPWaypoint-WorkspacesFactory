# HCP Terraform Workspace Add-on

This HCP Waypoint Add-on is use to provision a HCP Terraform Workspace.

## Overview

This add-on provisions a HCP Terraform Workspace using a HashiCorp Terraform no-code module. It is designed to help developers quickly deploy a HCP Terraform Workspace within the designated HCP project.
...
Instructions on how to use the add-on within the HCP Waypoint UI after you created an application.

1. Navigate to the **Applications** section in your HCP Waypoint dashboard.
2. Access your application.
3. Navigate to the **Add-ons** section in the left menu.
4. Click **Install** bext to the **HCPTerraformWorkspace** add-on.
